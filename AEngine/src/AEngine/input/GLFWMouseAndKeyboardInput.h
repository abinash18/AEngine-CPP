	...
	*/
	class AE_API GLFWMouseAndKeyboardInput : public Input {
		public:
			...
			void  setMouseX(const float mouse_x);
			float getMouseY1() const;
			void  setMouseY(const float mouse_y);
			...
			void setScrollOffsetX(const float scroll_offset_x);
			void setScrollOffsetY(const float scroll_offset_y);
