...
#define AE_CORE_CRITICAL(...)                                                  \
  ::AEngine::Log::GetCoreLogger()->critical(__VA_ARGS__)
...
/**
 * If this is a distrobution build then this will strip the logging statements
 * from the binary saving memory.
 */
